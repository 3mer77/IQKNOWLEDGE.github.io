...
let selected_div = document.querySelectorAll(".card");
...
function question() {
            ...
            req.open("GET",`../jsons/question.json`,true);
    req.send();
...
function Results(count){
    ...
    if (count === currentIndexQuestion){
        ...
        if (correctAnswer > (count / 2) && correctAnswer < 18) {
        ...
        } else if (correctAnswer >= 18 && correctAnswer <= 20 ) {
